...
const FooterMiddle = () => {
    return (
        <div className='footer__body row'>
            ...
            <ul className="footer__col col-lg-3 col-sm-6 col-xs-12">
                <li className="footer__item">
                    <a className="footer__link" href="#">Customer Service</a>
                </li>
                <li className="footer__item">
                    <a className="footer__link" href="#">Privacy Policy</a>
                </li>
                <li className="footer__item">
                    <a className="footer__link" href="#">Terms & Condition</a>
                </li>
                <li className="footer__item">
                    <a className="footer__link" href="#">Best Seller</a>
                </li>
                <li className="footer__item">
                    <a className="footer__link" href="#">Manufactures</a>
                </li>
            </ul>
